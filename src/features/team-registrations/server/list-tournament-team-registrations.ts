  ...
  async (tournamentId: string): Promise<TeamRegistrationDetail[]> => {
    const registrations = await prisma.teamRegistration.findMany({
      ...
      select: {
        ...
        gdprDocumentFileName: true,
        gdprDocumentMimeType: true,
        gdprDocumentSizeBytes: true,
        gdprDocumentUploadedAt: true,
        gdprPaperDeliveryMarkedAt: true,
        status: true,
        reviewedAt: true,
    ...
    return registrations.map((registration) => ({
      ...
      gdprDocumentFileName: registration.gdprDocumentFileName,
      gdprDocumentMimeType: registration.gdprDocumentMimeType,
      gdprDocumentSizeBytes: registration.gdprDocumentSizeBytes,
      gdprDocumentUploadedAt: registration.gdprDocumentUploadedAt,
      gdprPaperDeliveryMarkedAt: registration.gdprPaperDeliveryMarkedAt,
